...
const Home = () => {
  ...
  const products = [
    ...
    },
    {
      ...
      category: "Fitness",
      image: "https://images.unsplash.com/photo-1579758629934-095f71d22a3a?w=800",
      price: 89.99,
    },
    {
      id: 3,
      ...
      category: "Strength",
      image: "https://images.unsplash.com/photo-1589187155478-3f24f54ddde4?w=800",
      price: 29.99,
    },
    {
      id: 4,
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            {categories.map((cat, index) => (
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent flex flex-col justify-end p-6">
                  <h3 className="text-white mb-1">{cat.title}</h3>
                  <p className="text-white/80 text-sm">{cat.products} Products</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 p-4">
            {products.map((product) => (
              <div
                key={product.id}
                onClick={() => navigate("/Products")}
                className="group bg-white rounded-lg border overflow-hidden cursor-pointer transition-all hover:shadow-lg hover:-translate-y-1"
              >
                ...
                <div className="p-4">
                  ...
                  <h3 className="mb-2 text-base font-semibold">{product.title}</h3>
      ...
      <section className="py-20 bg-black text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="mb-4 text-3xl font-semibold">Get 20% Off Your First Order</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
            ...
            />
            <button className="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all bg-white text-black hover:bg-white/70 h-10 rounded-md px-6">
              Subscribe
            </button>
          </div>
        </div>
